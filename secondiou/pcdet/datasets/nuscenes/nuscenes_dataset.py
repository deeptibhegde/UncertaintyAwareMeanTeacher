...
class NuScenesDataset(DatasetTemplate):
    ...
    def get_sweep(self, sweep_info):
        ...
        try:
            ...
            points_sweep = np.fromfile("/media/HDD/vishwa/detection3d/OpenPCDet/data/nuscenes/v1.0-trainval/sweeps/LIDAR_TOP/n008-2018-05-21-11-06-59-0400__LIDAR_TOP__1526915243097718.pcd.bin", dtype=np.float32, count=-1).reshape([-1, 5])[:, :4]
